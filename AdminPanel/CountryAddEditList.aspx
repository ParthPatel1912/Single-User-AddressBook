<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Content/susan.master" AutoEventWireup="true" CodeFile="CountryAddEditList.aspx.cs" Inherits="Master_Page_AdminPanel_CountryAddEditList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <div class="row text-right" style="padding-top: 10px; padding-left: 250px;">
        <div class="col-md-3 font-weight-bold">
            Country &nbsp; Code
        </div>
        <div class="col-md-4 text-center">
